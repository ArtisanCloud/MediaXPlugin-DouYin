...
type MediaXPluginDouYin struct {
	PluginName string
...
func (p *MediaXPluginDouYin) Initialize(ctx *context.Context, arg interface{}) error {
...
func (p *MediaXPluginDouYin) Name(ctx *context.Context) string {
	return p.PluginName
}

func (p *MediaXPluginDouYin) Publish(ctx *context.Context, arg interface{}) (interface{}, error) {
